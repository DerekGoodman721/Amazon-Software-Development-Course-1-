...
public class DrivingSimLab {
    ...
    public static void changeGear() {
        ...
        keyBoard.nextLine();
        do {
            System.out.println("What Gear (P/D/R): ");
    ...
    public static void accelerate() {
        ...
        if (isEngineOn == true && !gear.equals("P")) {
            ...
            System.out.println("Error The Car Is Either Parked or The Engine Isn't On");
        }
    }
    ...
    public static void brake() {
        ...
        if (isEngineOn == true && speed > 5) {
            ...
            System.out.println("Error Car Isn't On Or Too Slow");
        }
    }
